...
func (ctrler *VPowerCtrler) ComputeWeight(height, ripeningBlocks int64, tau int64, totalSupply *uint256.Int) (decimal.Decimal, xerrors.XError) {
	...
	wvpow := Weight64ByPowerChunk(powChunks, height, ripeningBlocks, tau)
